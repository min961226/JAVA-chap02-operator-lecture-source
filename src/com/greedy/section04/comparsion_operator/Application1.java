package com.greedy.section04.comparsion_operator;
...
public class Application1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("inum1이 inum2보다 큰지 비교 : " + (inum1 > inum2));				//초과
		System.out.println("inum1이 inum2보다 크거나 같은지 비교 : " + (inum1 >= inum2));		//이상
		System.out.println("inum1이 inum2보다 작은지 비교 : " + (inum1 < inum2));				//미만
		System.out.println("inum1이 inum2보다 작거나 같은지 비교 : " + (inum1 <= inum2));		//이하
		...
		System.out.println("dnum1과 dnum2가 크거나 작은지 비교 : " + (dnum1 < dnum2));
		System.out.println("dnum1과 dnum2가 크거나 작거나 같은지 비교 : " + (dnum1 <= dnum2));
...
//		System.out.println("str1이 str2보다 큰지 비교 : " + (str1 > str2));
		...
		System.out.println("oracle".equals("oracle"));
