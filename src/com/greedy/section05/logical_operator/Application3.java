...
public class Application3 {
	...
	public static void main(String[] args) {
		 ...
		 * 조건식 두 개가 모두 만족해야 true를 반환하지만 앞에서 false가 나오게 되면 뒤의 조건을 확인할 필요 없이 false를 반환한다.
		 ...
		 * 조건식 둘 중에 하나라도 true를 반환하면 true가 반환되기 때문에 앞에서 미리 true가 나오게 되면 뒤에 조건을 확인하지 않는다.
